import 'package:homedecor/items.dart';
import 'package:homedecor/virtual_ar_view_screen.dart';
      ...
      floatingActionButton: FloatingActionButton.extended(
        ...
        onPressed: ()
        {
          ...
          Navigator.push(context, MaterialPageRoute(builder: (c)=> VirtualARViewScreen(
            ...
            clickedItemImageLink3d: widget.clickedItemInfo!.itemImage3d.toString(),
          )));
        },
        label: const Text(
