...
import 'package:homedecor/api_consumer.dart';
...
class _ItemsUploadScreenState extends State<ItemsUploadScreen>
{
  ...
  String downloadUrlOfUploadedImage3d = "";
  ...
  validateUploadFormAndUploadItemInfo() async
  {
    if(imageFileUint8List != null)
    {
          ...
          && itemPriceTextEditingController.text.isNotEmpty)
      {
        ...
        await taskSnapshot.ref.getDownloadURL().then((imageDownloadUrl3d)
        {
          downloadUrlOfUploadedImage3d = imageDownloadUrl3d;
        });
  ...
  saveItemInfoToFirestore()
  {
    ...
    FirebaseFirestore.instance
        ...
        .set(
        {
          ...
          "item3dImage": downloadUrlOfUploadedImage3d,
    ...
    // Call to Meshy API for 3D model generation
    generate3DModel(downloadUrlOfUploadedImage).then((_) {
